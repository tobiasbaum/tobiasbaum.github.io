var questions = [
	...
	{q: 'Wie viele Euro betrug der Median des Monats-Bruttoeinkommens eines Vollzeitangestellten in Deutschland in 2020?', a: 3427},
	{q: 'Wie viele Euro betrug der Median des Monats-Bruttoeinkommens eines männlichen Vollzeitangestellten in Deutschland in 2020?', a: 3565},
	{q: 'Wie viele Euro betrug der Median des Monats-Bruttoeinkommens einer weiblichen Vollzeitangestellten in Deutschland in 2020?', a: 3171},
	...
	{q: 'Wie viel Euro Pfand müssen für eine 1 Liter PET-Mehrwegflasche Limonade gezahlt werden (Stand 2021)?', a: 0.15},
	{q: 'Wie viele Gramm Zucker sind in einem Liter Coca-Cola enthalten?', a: 106},
	{q: 'In welchem Jahr endete die Militärdiktatur in Griechenland?', a: 1974},
	{q: 'Welchen Stand hatte der 1-Monats-Euribor-Zinssatz am 11.11.2011?', a: 1.201},
	{q: 'Wie viel kostet Microsoft 365 Business Standard pro Benutzer und Monat (Jahresabo mit autom. Verlängerung, Stand Dez. 2022, in Euro)?', a: 10.5},
	{q: 'Welche Dicke Kork in mm benötigt man, um die gleiche Wärmedämmwirkung zu erzielen wie 300 mm Beton?', a: 7.5},
	{q: 'Wie viel Dollar kostet Jira Cloud Standard für 50 Benutzer pro Jahr (Stand Dez. 2022)?', a: 3900},
	{q: 'Wie viel kostet ein virtueller Server VPS 1000 G10 (6 vCores, 8 GB RAM, 160 GB SSD) bei Netcup im Monat (Stand Dez. 2022, in Euro)?', a: 9.53},
	{q: 'Wie viele Bits umfasst ein Prozessorwort des Prozessors AMD Ryzen 7?', a: 64},
	{q: 'Wie viele Bytes Binär-Nutzdaten lassen sich maximal in einem QR-Code V7-L (45x45 Module) speichern?', a: 154},
	{q: 'Wie hoch war das (unrabattierte) Porto für einen Kompaktbrief der Deutschen Post AG am 4.5.2022 in Euro?', a: 1},
	{q: 'Wie viele Spielkarten umfasst ein Skatblatt?', a: 32},
	{q: 'Welchen Satz hatte die allgemeine Versicherungssteuer in Deutschland am 01.12.2022 in Prozent?', a: 19},
	{q: 'Wie viele Zähne enthält das Milchgebiss eines menschlichen Kindes?', a: 20},
	{q: 'Wie viele Blütenblätter hat eine Apfelblüte?', a: 5},
	{q: 'Wie viele Abgeordete hat der Deutsche Bundestag (Stand 01.12.2022)?', a: 736},
];
var lowerAnswers;
var upperAnswers;
var index;
